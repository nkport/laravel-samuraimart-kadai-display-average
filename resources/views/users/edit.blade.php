            ...
            <div class="col-md-5">
                    ...
                    <div class="form-group">
                        ...
                        <div class="collapse show editUserPhone">
                            <input id="postal_code" type="text"
                                ...
                                value="{{ $user->postal_code }}" required autocomplete="postal_code" autofocus
                ...
                <div class="d-flex justify-content-start">
                    <form method="POST" action="{{ route('mypage.destroy') }}">
                        ...
                        <div class="btn dashboard-delete-link" data-bs-toggle="modal"
                            data-bs-target="#delete-user-confirm-modal">退会する</div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn dashboard-delete-link"
